...
import { Currencies, DefaultChainID, ExplorerUrls } from "../configs/constants";
import { EXPLORER_URLS } from "../configs/constants/network";
import { getAirdropAddress } from "./addressHelpers";
...
export function getExplorerLink(chainId) {
  return `https://${EXPLORER_URLS[chainId]}/address/${getAirdropAddress(chainId)}`
}